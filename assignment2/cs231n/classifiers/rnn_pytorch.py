...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        # (2)Compute the word embedding
        x = word_embedding_forward(captions_in, W_embed) # (N, T, W)

        # (3)Compute the hidden states
    ...
    def sample(self, features, max_length=30):
        ...
        h = h0
        # Generate the words step by step
        for t in range(max_length):
          # Embed the previous words 
          x = word_embedding_forward(prev_words, W_embed) # (N, W)
          ...
          next_words = torch.argmax(scores, dim=1)  # (N,)
